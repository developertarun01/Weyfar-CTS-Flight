...
const Home = () => {
  ...
  const tabs = [
    {
      ...
      }australia-flights/images/aus.jpg`,
    },
  ];
  ...
  const airlines = [
    { id: 1, title: "Qantas", classes: "section2-card-1" },
    { id: 2, title: "United Airlines", classes: "section2-card-2" },
    { id: 3, title: "Delta Air Lines", classes: "section2-card-3" },
    { id: 4, title: "American Airlines", classes: "section2-card-4" },
    { id: 5, title: "Singapore Airlines", classes: "section2-card-5" },
    { id: 6, title: "British Airways", classes: "section2-card-6" },
    { id: 7, title: "Cathay Pacific", classes: "section2-card-7" },
    { id: 8, title: "Emirates", classes: "section2-card-8" },
    { id: 9, title: "Etihad Airways", classes: "section2-card-9" },
  ];
  ...
  return (
    ...
    url(${currentBg}) center/cover no-repeat`,
      ...
      >
        <div className="sliding-text-area">
          <p className="text-md mt-1 sliding-text">
            Expert assistance for booking flights to Sydney, Melbourne,
            Brisbane, and across Australia.
          </p>
        </div>
        <div className="container section1-container flex-mine-column">
          <div className="section1-heading flex-mine-column text-center">
            <h1 className="text-2xl font-semibold">
              Flights to Australia Made Easy
            </h1>

            <h3 className="text-sm font-medium mt-2 font-serif">
              Nonstop and one-stop options • Multiple airlines • 24/7 support
            </h3>
          </div>
          ...
          <div className="good-cards row flex-mine">
            <div className="good-card-1 col flex-mine-column px-5 text-center ">
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/flexpay-logo.webp`}
                alt=""
                width="150px"
                height="50px"
              />
            ...
            <div className="good-card-2 col flex-mine-column px-5  text-center">
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/customer-icon.webp`}
                alt=""
                width="50"
                height="50"
              />
            ...
            <div className="good-card-3 col flex-mine-column px-5 text-center">
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/happy-cutomer.svg`}
                alt=""
                width="50px"
                height="50px"
              />
      ...
      <section className="section3">
        <div className="section3-inner container">
          <TopFlights
            key="Melbourne"
            props={{ type: "Melbourne", classes: "section3-header-1" }}
          />
          <TopFlights
            key="Sydney"
            props={{ type: "Sydney", classes: "section3-header-2" }}
          />
        </div>
      </section>
      ...
      <section className="section4">
        <div className="container section4-inner">
          ...
          <p>
            Last updated <span>5 minute ago,</span> the fares mentioned above
            are for flight tickets and inclusive of fuel surcharges, service fee
            and taxes . Based on historical data, these fares are subject to
            change without prior notice and cannot be guaranteed at the time of
            booking. Kindly go through our terms and conditions before booking.
          </p>
          ...
          <div className="section4-banner">
            <div className="flex-mine section4-banner-img">
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/airplane.png`}
                alt=""
                width="220px"
              />
            </div>
            <div className="section4-banner-text">
              <h1>Need help with complex routes, long layovers, or changes?</h1>
              <p>Our agents can assist.</p>
      ...
      <section className="section3 container">
        <h2 className="mb-15 text-2xl font-semibold text-center">
          Why People choose Weyfar for Australia Flights
        </h2>
        <p className="text-center">
          Weyfar is a trusted travel platform for booking affordable and
          convenient Australia flights, offering travelers a seamless experience
          from search to checkout. Whether you are planning a business trip, a
          family vacation, or a student journey, Weyfar provides a wide range of
          flight options from top airlines, ensuring competitive prices and
          flexible schedules. Our advanced search tools help users compare
          fares, routes, and travel times, making it easier to find the perfect
          flight that fits both budget and preferences. <br />
          <br />
          With Weyfar, customers benefit from transparent pricing, no hidden
          charges, and real-time fare updates, ensuring complete peace of mind
          while booking. Our dedicated customer support team is always available
          to assist with flight changes, cancellations, and travel queries,
          making us a reliable choice for international travel. We also offer
          exclusive deals, seasonal discounts, and special offers on Australia
          flights, helping travelers save more. <br />
          <br />
          From easy online booking to secure payment options, Weyfar focuses on
          comfort, reliability, and customer satisfaction. This commitment to
          quality service and affordable travel solutions is why thousands of
          travelers choose Weyfar for their Australia flight bookings every
          year.
        </p>
      </section>
        ...
        <div className="container section7-inner flex-mine-column">
          ...
          <div className="flex-mine section7-favicon ">
            <img
              src={`${
                import.meta.env.BASE_URL
              }australia-flights/images/tp-logo.webp`}
              alt=""
              width="150px"
              height="30px"
            />
            <img
              src={`${
                import.meta.env.BASE_URL
              }australia-flights/images/stars-4.5.svg`}
              alt=""
              width="150px"
              height="30px"
            />
