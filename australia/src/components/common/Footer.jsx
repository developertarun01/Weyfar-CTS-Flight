    ...
    <>
          ...
          <div className="section9-icons">
            <div className="section9-icons-1">
              <img
                ...
                }australia-flights/images/IATA.webp`}
                alt="IATA"
              ...
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/arc.png`}
                alt="ARC"
                style={{ width: "100%", height: "40px" }}
              />
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/cloudflare.webp`}
                alt="Cloudflare"
                style={{ width: "100%", height: "40px" }}
              />
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/digicert.webp`}
                alt="Digicert"
                style={{ width: "100%", height: "40px" }}
              />
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/PCI.webp`}
                alt="PCI"
                style={{ width: "100%", height: "40px" }}
              />
            </div>
            <div>
              <img
                src={`${
                  import.meta.env.BASE_URL
                }australia-flights/images/payment.png`}
                alt="Payments"
                style={{ width: "100%" }}
              />
            </div>
      ...
      <Link to="tel:8888082182">
        <div className="sm:hidden fixed bottom-0 w-full bg-[var(--accent-dark)] text-white text-center h-14 flex justify-center items-center gap-2 text-xl">
          ...
          <b className="text-lg">Speak to a Flight Expert</b>
        </div>
      </Link>
    </>
  );
