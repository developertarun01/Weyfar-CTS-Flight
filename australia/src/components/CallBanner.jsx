...
const CallBanner = () => {
  return (
    <div className="bg-[var(--primary)] bg-[url('/australia-flights/images/travel.png')] bg-repeat bg-top bg-[length:110px_110px] bg-blend-screen flex flex-col sm:grid sm:grid-rows-1 sm:grid-cols-2 px-0 sm:px-16 py-0 sm:py-5 rounded-xl callBanner">
      <div className="flex justify-center items-center my-2 sm:my-0">
        <img src={`${import.meta.env.BASE_URL}australia-flights/images/airplane.png`} alt="airplane image" width="250px" />
      </div>
